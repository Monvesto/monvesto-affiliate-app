...
class P2PDetailScreen extends StatefulWidget {
  ...
  const P2PDetailScreen({super.key, required this.provider});
...
class _P2PDetailScreenState extends State<P2PDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final minInvestment = provider['minInvestment'] != null
        ? provider['minInvestment'].toString()
        : 'k.A.';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _infoRow('Mindestinvestment', minInvestment),
                        const Divider(color: Colors.white12),
                        _infoRow(
                          'Buyback Garantie',
                          provider['buyback'] == true ? 'Ja ✓' : 'Nein',
                          valueColor: provider['buyback'] == true
                        ...
                        _infoRow(
                          'Auto-Invest',
                          provider['autoInvest'] == true ? 'Ja ✓' : 'Nein',
                          valueColor: provider['autoInvest'] == true
                              ? const Color(0xFF00D4AA)
                              : Colors.white54,
                        ),
                        const Divider(color: Colors.white12),
                        _infoRow(
                          'Sekundärmarkt',
                          provider['secondaryMarket'] == true ? 'Ja ✓' : 'Nein',
                          valueColor: provider['secondaryMarket'] == true
                              ? const Color(0xFF00D4AA)
                              : Colors.white54,
                        ),
                        const Divider(color: Colors.white12),
                        _infoRow('Ø Laufzeit', provider['avgDuration'] ?? 'k.A.'),
                        const Divider(color: Colors.white12),
