              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _infoRow('Ordergebühren',
                            provider['orderFee'] ?? 'k.A.'),
                        const Divider(color: Colors.white12),
                        _infoRow('Depot Gebühren',
                            provider['depotFee'] ?? 'k.A.'),
                        const Divider(color: Colors.white12),
                        _infoRow('Verfügbare Märkte',
                            provider['markets'] ?? 'k.A.'),
                        const Divider(color: Colors.white12),
                        _infoRow(
                          'ETF Sparpläne',
                          provider['etfSavingsPlan'] == true
                              ? 'Ja ✓'
                              : 'Nein',
                        ...
                        const Divider(color: Colors.white12),
                        _infoRow('Zinsen auf Guthaben',
                            provider['interestRate'] ?? 'k.A.'),
                        const Divider(color: Colors.white12),
